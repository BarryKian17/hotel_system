                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="file" name="photo" class="form-control" id="image" value="" />
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage" src="{{ (!empty(Auth::user()->photo)) ? url('storage/profile/'.Auth::user()->photo) : url('storage/user.jpg') }}" width="100px" alt="">
                                    </div>
