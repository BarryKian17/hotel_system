            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Room Number Edit</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <form action="{{ route('room.number.update', $roomNumber->id) }}" id="myForm" method="POST">
                                @csrf
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary form-group">
                                            <select name="status" id="input7" class="form-select">
                                                <option value="Active"
                                                    {{ $roomNumber->status == 'Active' ? 'selected' : '' }}>Active
                                                </option>
                                                <option value="Inactive"
                                                    {{ $roomNumber->status == 'Inactive' ? 'selected' : '' }}>Inactive
                                                </option>
                                            </select>
                                        </div>
                                    </div>
